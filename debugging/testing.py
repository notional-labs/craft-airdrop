from utils import convert_address_to_craft
# from utils import GENESIS_VALIDATORS, BLACKLISTED_CENTRAL_EXCHANGES, NETWORKS, AIRDROP_DISTRIBUTIONS
...
def test_address_conversions():
    # terra, kava, and evmos fail due to HD path difference. Add dig 0x addresses here to fail too?
    for addr in [
